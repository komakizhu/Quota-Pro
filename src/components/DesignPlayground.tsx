...
const preferences: WidgetPreferences = { locked: false, alwaysOnTop: true, widgetMode: "expanded", widgetSize: "medium", compactSize: 72, expandedSize: 306, pinnedProvider: "codex", autoRotateSeconds: 12, language: "en", appearance: "system", license: null, licenses: [], unlockedSkin: null, unlockedSkins: [], selectedSkin: "default" };
